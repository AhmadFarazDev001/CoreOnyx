    ...
    return (
      <div className="w-full max-w-3xl mx-auto">
        <div className="mb-8 animate-page-in">
          <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Q&A Management</h1>
          <p className="text-[var(--text-secondary)]">Manage student questions and public discussions.</p>
        </div>
        <EmptyState
          icon={MessageSquare}
          title="No discussions yet"
          description="Student queries will appear here."
          className="animate-page-in"
          action={
            <NewThreadButton isAdmin={true} className="mt-4 gap-2">
      ...
      <div className={cn(
        ...
        <div className="flex flex-col">
          <ThreadListWrapper 
            ...
            activeId={params.id || activeThread?.id || ''} 
